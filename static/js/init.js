...
// Auto-configure server URL — skip onboarding, fix localhost:7000
(function autoServerUrl() {
  const saved = Storage.get(Storage.KEYS.SERVER_URL);
  if (!saved) {
    Storage.set(Storage.KEYS.SERVER_URL, 'http://localhost:7000');
  }
  // Redirect to /chat if on landing page
