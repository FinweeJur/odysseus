...
export const THEMES = {
  ...
  // Cutia — identidade visual do Cerrado: terracota, verde-seco e amarelo-quente
  cerrado:    { bg:'#F5F3F0', fg:'#4A3B2A', panel:'#FFFFFF', border:'#D8D4CC', red:'#D4955D',
                green: '#639922',
                advanced: { sidebarBg: '#E8B88A', brandColor: '#D4955D',
                            hamburgerColor: '#D4955D',
                            sendBtnBg: '#D4955D', sendBtnHover: '#BA7517',
                            toggleActive: '#639922',
                            userBubbleBg: '#E8B88A', aiBubbleBg: '#FFFFFF',
                            bubbleBorder: '#D8D4CC',
                            inputBg: '#FFFFFF', inputBorder: '#D8D4CC',
                            codeBg: '#F5F3F0', codeFg: '#4A3B2A' } },
};

const DEFAULT_THEME = 'cerrado';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Logo do Cutia',    group: 'Sidebar' },
